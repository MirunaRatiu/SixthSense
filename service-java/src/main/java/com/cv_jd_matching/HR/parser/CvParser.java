            ...
            <task>
                          ...
                          <steps>
                            ...
                            <step>
                              ...
                              <details>
                                Identify the relevant sections for technical skills using titles such as "Technical Skills", "Skills", "Technical", "Programming Languages". Analyze the content of these sections to extract each individual technical skill, taking into account the following rules:
                                ...
                                **Rules for Separating Multiple Skills:**
                                If a line or a list item contains multiple skills separated by a comma (,), **treat each comma-delimited segment as a distinct skill.** Remove any unnecessary whitespace from the beginning and end of each resulting skill.
                                 After splitting by commas, for each resulting skill, check for and split further by the | (pipe) or / (slash) characters.
                            ...
                            <step>
                              ...
                              <details>
                                ...
                                **Look for and extract any mentioned technologies, tools, or methodologies associated with the certification and include them in a "technologies" list .**
                                 After splitting by commas, for each resulting technology, check for and split further by the | (pipe) or / (slash) characters.
                            ...
                            <step>
                              <details>
                                ...
                                **Detailed and Prioritized Instructions for Parsing the "others" Section:**
                                ...
                                1.  **Identify Explicit Titles:** Look for lines or phrases that are formatted as titles (e.g., bold, underlined, with a larger font size, separated by blank spaces). These indicate the beginning of a new sub-section (e.g., "Contact", "Interests").
